...
public class LibraryCardService {
    ...
    public void updateLibrary(Integer libraryId, String card_number)
    {
         ...
         if(card_number != null & libraryCard.getCard_number() != card_number)
         {
             Optional<LibraryCard> libraryCarByName = libraryCardRepository.findLibraryCardByCardNumber(card_number);
             if(libraryCarByName.isPresent())
             {
                 throw new IllegalStateException("Card_number already exist in database");
             }
